# Org Templates Admin UI

## Purpose
TBD: This capability provides the admin-only user interface for browsing the catalog of built-in org templates and applying one to an organization.
