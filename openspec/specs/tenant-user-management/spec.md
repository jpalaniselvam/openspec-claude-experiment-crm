# Capability: tenant-user-management

## Purpose

Defines the API behaviour for managing users within a tenant/organization context, including role-based access control, user listing, creation, and updates.
